<div id="modal-edit-client" class="modal fade" tabindex="-1">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="radio-group">
                                            <div class="el-radio">
                                                <input type="radio" name="gender" id="edit-m" value="option">
                                                <label class="el-radio-style" for="edit-m"></label>
                                            </div>
                                            <label class="label-checkbox">Masculino</label>
                                            <div class="el-radio">
                                                <input type="radio" name="gender" id="edit-f" value="option">
                                                <label class="el-radio-style" for="edit-f"></label>
                                            </div>
                                        ...
                                        <div class="col-xs-4 text-center">
                                            <div class="radio-group text-center">
                                                <label class="label-checkbox displayTitlesInverse">Preferente</label>
                                                    ...
                                                    <input type="radio" name="edit-prefer" id="edit-a" value="option" checked>
                                                    <label class="el-radio-style" for="edit-a"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 text-center">
                                            <div class="radio-group text-center mt5">
                                                ...
                                                <div class="el-checkbox">
                                                    <input type="checkbox" name="edit-check" id="edit-1">
                                                    <label class="el-checkbox-style" for="edit-1"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="form-group input-group">
                                        ...
                                        <input type="text" class="form-control" id="popular_mails_B" placeholder="Escribe 'i'">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-5">
                                    <div class="row text-center mb10-xs">
                                        <div class="col-xs-4">
                                            <div class="radio-group text-center">
                                                <label class="label-checkbox displayTitlesInverse">Preferente</label>
                                                <div class="el-radio mt5">
                                                    <input type="radio" name="edit-prefer" id="edit-b" value="option">
                                                    <label class="el-radio-style" for="edit-b"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                            <div class="radio-group text-center mt5">
                                                <label class="label-checkbox displayTitlesInverse">No disponible</label>
                                                <div class="el-checkbox">
                                                    <input type="checkbox" name="edit-check" id="edit-2">
                                                    <label class="el-checkbox-style" for="edit-2"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                    ...
                                    <div class="row text-center mb10-xs">
                                        <div class="col-xs-4">
                                            <div class="radio-group text-center">
                                                <label class="label-checkbox displayTitlesInverse">Preferente</label>
                                                <div class="el-radio mt5">
                                                    <input type="radio" name="edit-prefer" id="edit-c" value="option">
                                                    <label class="el-radio-style" for="edit-c"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                            <div class="radio-group text-center mt5">
                                                <label class="label-checkbox displayTitlesInverse">No disponible</label>
                                                <div class="el-checkbox">
                                                    <input type="checkbox" name="edit-check" id="edit-3">
                                                    <label class="el-checkbox-style" for="edit-3"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="form-group has-feedback has-feedback-left">
											<input type="text" class="form-control" placeholder="Escribe 'di'" id="distrito_B">
            ...
            <div class="modal-footer">
                <div class="col-sm-12">
                    <div class="form-group mt0">
                        <div class="radio-group text-center">
                            <div class="el-checkbox">
                                <input type="checkbox" name="check_agree_2" id="check_agree_2">
                                <label class="el-checkbox-style" for="check_agree_2"></label>
                            </div>
                        </div>
                ...
                <button type="button" class="btn btn-alpha btn-std btn-rounded">Agregar</button>
            </div>
        </div>
    </div>
</div>
